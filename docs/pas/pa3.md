...
- [`vmalloc` checkpoint](#the-checkpoint): May 14
- Due date: May 20 23:59 PDT
{: .fs-4 }
...
[classroom]: https://classroom.github.com/a/pWKtTQKE
...
This is identical to the `clang-format` command we gave you in previous PAs.
...
If you are able to reach the checkpoint by **Wednesday (May 14, 2025)**, it means you are on right track.
...
The last part of this assignment is, once again, a reflection survey. Please
spend a few minutes reflecting on your experience in this course as we approach
its end. We read every single submission to help improve this course!

[Take Reflection Survey 3](https://docs.google.com/forms/d/e/1FAIpQLSehpFUPQ8vwrZMiGP9IucQzZJleOKctgAPbatmiR4lCHkK7wg/viewform?usp=sharing){: .btn .btn-purple }

## Grading and Point Distribution

To evaluate your work, the autograder runs each test in the `tests` directory
of the starter code against your submission. To help you troubleshoot, the
autograder uses a verbose version of each test that shows the meaning of each
assertion. Results for `test_alloc_large`, `test_alloc_zero`, and
`test_free_coalesce_lr` will be hidden until after the deadline, but all other
test results will be public.

Each test is worth 5 points. If a test produces correct output but causes errors
in Valgrind, you receive 4 points for that test.

| Component | Breakdown | Points available |
|:----------|:----------|:-----------------|
| Compilation | 4 points for compiling successfully | 4 |
| `vmalloc` tests | 8 public tests and 2 private tests; 5 points per test | 50 |
| `vmfree` tests | 4 public tests and 1 private test; 5 points per test | 25 |
| Reflection Survey 3 | 1 point for submission | 1 |
